...
&& apk upgrade -U -a \
&& apk add --no-cache libstdc++ chromium chromium-chromedriver harfbuzz nss freetype ttf-freefont \
&& rm -rf /var/cache/* \
&& mkdir /var/cache/apk
...
&& apk add --update python3-dev py3-pip py3-numpy py3-pandas py3-matplotlib \
