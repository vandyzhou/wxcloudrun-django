...
DOMAINS = {'sina': 'sina.com.cn', 'sinahq': 'sinajs.cn',
           ...
           'dfcf': 'nufm.dfcfw.com', 'jsl': 'www.jisilu.cn'}
...
BOND_COLS = ['symbol', 'name', 'trade', 'pricechange', 'changepercent', 'buy', 'sell', 'settlement',
             'open', 'high', 'low', 'volume', 'amount', 'code', 'ticktime']
BOND_COLS1 = ['amount', 'buy', 'changepercent', 'code', 'high', 'low', 'name', 'open', 'pricechange', 'sell', 'settlement', 'symbol', 'ticktime', 'trade',
             'volume']
...
BOND_URL = '%s%s/quotes_service/api/json_v2.php/Market_Center.getHQNodeDataSimple?page=%s&num=%s&sort=symbol&asc=1&node=hskzz_z&_s_r_a=page'
JSL_BOND_URL = '%s%s/data/cbnew/cb_list_new/?___jsl=LST___t=%s'
